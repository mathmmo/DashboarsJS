  ...
  MetisMenu.prototype.init = function() {
    ...
    this
      ...
      .on('click.metisMenu', function(e) {
        ...
        $list.each(function(index, element) {
          ...
          if ($element.hasClass(activeClass) && $element.find($anchor).length == 0) {
            $this.hide($children);
          }
        });
    ...
    $(window).on('hashchange', function() {
      ...
      if (currentHash.length > 0) {
        currentHash = currentHash[0] + '/' + currentHash[1];
      } else {
      ...
      $list.each(function(index, element) {
        var $element = $(element);
        var isCurrentAnchor = $element.find('a[href^="' + currentHash + '"]');
        if (isCurrentAnchor.length > 0) {
          var $children = $element.children('ul');
